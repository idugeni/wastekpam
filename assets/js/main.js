document.addEventListener('DOMContentLoaded', () => {
  ...
  function updateReguDetails(selectElement, kaRupamId, anggota1Id, anggota2Id, p2uId) {
  ...
  function generateLaporan() {
    ...
    const hasilLaporan = "*ASTEKPAM RUTAN KELAS IIB WONOSOBO*\n"
  ...
  function copyLaporan() {
    ...
    navigator.clipboard.writeText(laporanTextarea.value)
        .then(() => {
